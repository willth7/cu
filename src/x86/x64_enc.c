...
void x86_64_enc_pnt_call_8(uint8_t* bin, uint64_t* bn, void (*dec_stack) (uint8_t), uint8_t reg, uint8_t* str, uint8_t len, uint16_t sz) {
	reg = x86_64_inc_reg(reg);
	
	x86_64_enc_call_reg(bin, bn, reg | 48); //call [func]
	if (sz) { //removes argument stack
		x86_64_enc_add_reg_imm(bin, bn, 52, sz); //add rsp, [sz]
		dec_stack(sz);
	}
...
void x86_64_enc_pnt_call_16(uint8_t* bin, uint64_t* bn, void (*dec_stack) (uint8_t), uint8_t reg, uint8_t* str, uint8_t len, uint16_t sz) {
	reg = x86_64_inc_reg(reg);
...
void x86_64_enc_pnt_call_32(uint8_t* bin, uint64_t* bn, void (*dec_stack) (uint8_t), uint8_t reg, uint8_t* str, uint8_t len, uint16_t sz) {
	reg = x86_64_inc_reg(reg);
...
void x86_64_enc_pnt_call_64(uint8_t* bin, uint64_t* bn, void (*dec_stack) (uint8_t), uint8_t reg, uint8_t* str, uint8_t len, uint16_t sz) {
	reg = x86_64_inc_reg(reg);
...
void x86_64_enc_pnt_call_void(uint8_t* bin, uint64_t* bn, void (*dec_stack) (uint8_t), uint8_t reg, uint8_t* str, uint8_t len, uint16_t sz) {
	reg = x86_64_inc_reg(reg);
